  ...
  <div class="habit">
    ...
    <section>
      ...
      <router-link :to="{path:'habit',query:{id:newHabit.id}}">
        <van-cell @click="create(newHabit.id)" :value="newHabit.id">
    ...
    <section>
      <h4>从库中挑选习惯</h4>
      <van-list>
        <van-cell v-for="item in habitLibrary" :key='item.id' @create="(item.id)" :value="item.title">
